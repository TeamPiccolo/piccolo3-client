...
async def main():
    ...
    print (await pclient.control.get_status(),await pclient.control.get_current_sequence())
    ...
    print ('min,max',await pclient.spec[s].get_min_time(), await pclient.spec[s].get_max_time())
